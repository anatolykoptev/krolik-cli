 ...
 * @example
 * // Low-level visitor
 * import { parseFile, visitNode, getNodeType } from '@/lib/parsing/swc';
 *
 ...
 * @example
 * // Validate syntax
 * import { validateSyntax } from '@/lib/parsing/swc';
 *
 ...
 * import { getCalleeName, collectMethodChain, extractStringArg } from '@/lib/parsing/swc';
 *
 * visitNodeWithCallbacks(ast, {
