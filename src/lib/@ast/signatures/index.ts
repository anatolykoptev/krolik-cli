 ...
 * @example
 * // High-level API
 * import { extractSignatures, extractSignaturesFromFiles } from '@/lib/@ast/signatures';
 *
 ...
 * import { parseFile, calculateLineOffsets } from '@/lib/@ast/swc';
 *
 ...
 * import { extractSignatureText, findSignatureEnd } from '@/lib/@ast/signatures';
 *
...
import { parseFile as swcParseFile } from '@/lib/@ast/swc';
...
// the version in @/lib/@ast/swc/parser. Use getNodeSpan from swc instead.
export {
