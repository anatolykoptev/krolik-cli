 ...
 */
export function createFelixLogger(options: LoggerOptions = {}): RalphLogger {
 ...
 */
export const ralphLogger = createFelixLogger();

/**
 * Create a logger for a specific component
 */
export function createComponentLogger(component: string): RalphLogger {
  return createFelixLogger({ prefix: `ralph:${component}` });
}
