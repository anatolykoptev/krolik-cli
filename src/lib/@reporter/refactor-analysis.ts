...
async function findLibPathWithMonorepo(projectRoot: string): Promise<string | undefined> {
  ...
  const { findLibPath } = await import('../../commands/refactor/paths');
...
export async function computeRanking(projectRoot: string): Promise<RankingSummary | undefined> {
  try {
    const { analyzeArchHealth } = await import('../../commands/refactor/analyzers/architecture');
    const { analyzeRanking } = await import('../../commands/refactor/analyzers/ranking');
...
export async function computeRecommendations(
  ...
  try {
    const { analyzeArchHealth, classifyDomains } = await import(
      '../../commands/refactor/analyzers/architecture'
    );
    const { generateRecommendations } = await import(
      '../../commands/refactor/analyzers/metrics/recommendations'
    );
    const { findDuplicates } = await import('../../commands/refactor/analyzers/core/duplicates');
...
export async function createImpactEnricher(
  ...
  try {
    const { analyzeArchHealth } = await import('../../commands/refactor/analyzers/architecture');
    const { ImpactEnricher: Enricher } = await import('../@krolik/enrichment');
