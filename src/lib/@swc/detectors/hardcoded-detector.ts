...
import { ACCEPTABLE_NUMBERS, shouldSkipUrl } from '../../@patterns/hardcoded/index';
import { getContext } from '../visitor';
import type { DetectorContext, HardcodedDetection } from './types';
