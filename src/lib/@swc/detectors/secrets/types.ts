/**
 * @module lib/@swc/detectors/secrets/types
 * @description Type definitions for secret detection
 */

import type { SecretDetectorContext, SecretSeverity, SecretType } from '../types';

// Re-export for convenience
export type { SecretDetection, SecretDetectorContext, SecretSeverity, SecretType } from '../types';
