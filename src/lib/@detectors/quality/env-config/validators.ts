/**
 * @module lib/@detectors/quality/env-config/validators
...
import { shouldSkipForEnvConfig } from '../../patterns/skip-logic';
import {
 ...
 *
 * @deprecated Import shouldSkipForEnvConfig from '@detectors/skip-patterns' directly
 */
