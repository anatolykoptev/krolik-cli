/**
 * @module lib/@detectors/quality/hardcoded/detection
 * @description Detection patterns and rules for hardcoded values
 */

import { shouldSkipForHardcoded } from '../../patterns/skip-logic';
 ...
 *
 * @deprecated Import shouldSkipForHardcoded from '@detectors/skip-patterns' directly
 */
