/**
 * @module lib/@detectors/quality/hardcoded/detector
...
import type { DetectorContext, HardcodedDetection } from '../../patterns/ast/types';
// Import directly from source modules to avoid circular dependency with index.ts
import { ACCEPTABLE_NUMBERS } from './numbers';
import { shouldSkipUrl } from './urls';
