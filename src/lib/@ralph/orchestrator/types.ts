...
export interface RalphOrchestratorConfig {
  ...
  /** Use true multi-agent mode with ADK SequentialAgent/ParallelAgent (default: false) */
...
export type ResolvedConfig = Required<
  Omit<RalphOrchestratorConfig, OptionalConfigKeys | DefaultedConfigKeys>
> &
  Pick<RalphOrchestratorConfig, OptionalConfigKeys> & {
    [K in DefaultedConfigKeys]: NonNullable<RalphOrchestratorConfig[K]>;
  };
