...
export interface RalphAttemptRow {
  id: number;
  task_id: number;
  prd_task_id: string;
...
export interface RalphAttemptCreate {
  taskId: number;
  prdTaskId: string;
  attemptNumber: number;
  model?: string;
...
export interface RalphAttemptComplete {
  success: boolean;
  inputTokens?: number;
  outputTokens?: number;
  costUsd?: number;
...
export interface RalphGuardrailRow {
  id: number;
  project: string;
  type: string;
  category: string;
...
export interface RalphGuardrail {
  id: number;
  project: string;
  type: MemoryType;
...
export interface RalphGuardrailCreate {
  project: string;
  type?: MemoryType;
  category: GuardrailCategory;
  severity: GuardrailSeverity;
