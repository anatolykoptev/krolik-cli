...
} from '@/lib/@ralph/router/cost-estimator';
import { MODEL_INFO } from '@/lib/@ralph/router/rules';
...
describe('CostEstimator', () => {
  describe('estimateTaskCost', () => {
    ...
    it('should assign cheap model for trivial tasks', () => {
      const task: TaskAttributes = {
        id: 'trivial-task',
        complexity: 'trivial',
      };
      ...
      // Trivial should get cheap tier model (flash or haiku)
