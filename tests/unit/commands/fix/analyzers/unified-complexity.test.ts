...
describe('analyzeFileUnified - complexity detection', () => {
  it('should extract functions with complexity metrics', () => {
    const code = `
...
`;
    ...
    const result = analyzeFileUnified(code, 'test.ts');
  ...
  it('should count complexity for control flow statements', () => {
    const code = `
...
`;
  ...
  it('should count switch cases as complexity', () => {
    const code = `
...
`;
  ...
  it('should track exported vs non-exported functions', () => {
    const code = `
...
`;
  ...
  it('should return both complexityIssues and functions arrays', () => {
    const code = `
